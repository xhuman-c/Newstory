...
checkpoint = torch.load('checkpoints/best-checkpoint.ckpt', map_location=torch.device('cpu'))
...
text = '''10대 청소년들에게 마약을 전자담배라고 속여 피우게 하거나 이를 거부할 경우 강제로 피우게 한 남성들에게 1심 법원이 실형을 선고했다.
16일 법조계에 따르면 수원지법 형사11부(신진우 부장판사)는 마약류관리법상 미성년자 마약제공 혐의로 기소된 A씨(21)에게 징역 10년, B씨(20)에게 징역 8년을 각각 선고했다. 또한 같은 혐의로 기소된 C군(19)에게는 징역 6년, D군(16)에게는 단기 3년에 장기 5년을 선고했다.
재판부는 “이번 범행은 미성년자를 영리 취득 대상으로 삼고, 심각한 신체적·정신적 피해를 줄 위험이 있어 피고인들의 죄질이 극히 불량하다”고 지적했다.
이어 “피고인들이 범죄계획을 세우고 역할을 조직적으로 나눠 범행을 저질렀고, 발각 이후 증거를 인멸하기도 해 비난 가능성이 높다"면서도 “해당 사건을 통해 얻은 이익이 크지 않고, 범행을 인정하고 반성하는 듯한 모습을 보이는 점 등을 정상 참작했다”고 밝혔다.
동네 선후배 사이인 A씨 등은 올해 3~4월 마약 판매상으로부터 합성 대마를 매수한 뒤 고교생 6명에게 전자담배라고 속인뒤 피우게 한 혐의로 기소됐다.
이들은 또한 일부 피해자들이 흡연을 거부하자 협박을 통해 강제로 합성 대마를 흡연하게 한 것으로도 드러났다.
경찰 조사 과정에서 이들은 피해자들을 마약에 중독시킨 뒤 이후 이들에게 마약을 팔아 이윤을 남기려 했다고 진술한 것으로 알려졌다.
검찰은 앞서 A씨에게 징역 15년, B씨에게 징역 12년, C군과 D군에게는 단기 5년에 장기 10년을 각각 구형했다.'''

a = summarize_test(text)
print(a)